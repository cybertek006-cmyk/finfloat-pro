      ...
      builder: (c, snap) {
        ...
        return ListView(padding: const EdgeInsets.all(14), children: [
          ...
          FilledButton(
            ...
            onPressed: () => _open(const DayEndForm()),
            child: const Text('📋 Day-End Summary (poore din ka total)',
                style: TextStyle(fontSize: 13)),
          ),
          const SizedBox(height: 8),
          const Text('Ya single entry:',
              ...
              return Tile(
                ...
                onMenu: () async {
                  ...
                  if (r == 'edit' && mounted) {
                    ...
                    final go =
                        await confirm(context, 'Delete party?', '${p['name']}');
...
class _CashTabState extends State<CashTab> {
  ...
  Future<Map<String, dynamic>> _load() async {
    ...
    return {
      ...
      'totalCash': await Repo.i.totalCash(),
      'transfers': await Repo.i.transfers(date: d),
      ...
      builder: (c, snap) {
        ...
        return ListView(padding: const EdgeInsets.all(14), children: [
          ...
          Row(children: [
            Expanded(
              child: Container(
                ...
                child: Column(
                    ...
                    children: [
                      const Text('👤 Mera Cash',
                          style: TextStyle(color: Colors.white70, fontSize: 11)),
                      const SizedBox(height: 3),
                      FittedBox(
                        fit: BoxFit.scaleDown,
                        alignment: Alignment.centerLeft,
                        child: Text(money(numOf(d['myCash'])),
                            style: const TextStyle(
                                color: Colors.white,
                                fontSize: 19,
                                fontWeight: FontWeight.w700)),
                      ),
                      const Text('CMS ka cash',
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                      colors: [C.warning, Color(0xFFFFB347)]),
                  borderRadius: BorderRadius.circular(14),
                ),
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
          ...
          AppCard(
            ...
            child: Row2('Total Cash', money(numOf(d['totalCash'])),
                bold: true, color: C.accent),
          ),
          ...
          Row(children: [
            Expanded(
              child: FilledButton(
                ...
                onPressed: () => _open(const TransferForm()),
                child: const Text('🔄 Transfer', style: TextStyle(fontSize: 12.5)),
              ),
            ),
            const SizedBox(width: 9),
            Expanded(
